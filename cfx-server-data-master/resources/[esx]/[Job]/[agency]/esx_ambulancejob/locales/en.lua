Locales['en'] = {
  ...
  ['ems_clothes_civil'] = 'ชุดธรรมดา',
  ['ems_clothes_ems'] = 'ชุดพยาบาล',
  -- Vehicles
  ['ambulance'] = 'ambulance',
  ...
  ['confirm_yes'] = 'yes',
  -- Armory
  ['remove_object'] = 'ถอนของออกจากคลัง',
  ['deposit_object'] = 'ใส่ของเข้าคลัง',
  ...
  -- F6 Menu
  ['ems_menu'] = 'เมนูพยาบาล',
  ['ems_menu_title'] = '<span style="font-size: 24px;">Ambulance - EMS Menu</span>',
  ['ems_menu_revive'] = 'ชุบชีวิตผู้เล่น',
  ['ems_menu_putincar'] = 'ใส่ผู้เล่นเข้าไปในรถ',
  ['ems_menu_small'] = 'รักษาแผลเล็กน้อย',
  ['ems_menu_big'] = 'รักษาแผลสาหัส',
  -- Phone
  ['alert_ambulance'] = 'Loaded',
  -- Death
  ['respawn_available_in'] = '~y~จะเกิดใน ~r~%s ~y~นาที ~r~%s ~y~วินาที~s~',
  ['respawn_bleedout_in'] = 'you will bleed out in ~b~%s minutes %s seconds~s~\n',
  ['respawn_bleedout_prompt'] = 'hold [~b~H~s~] to respawn',
  ['respawn_bleedout_fine'] = 'hold [~b~H~s~] to respawn for ~g~$%s~s~',
  ['respawn_bleedout_fine_msg'] = 'you paid ~r~$%s~s~ to respawn.',
  ['distress_send'] = 'กด [~r~G~s~] เพื่อส่งสัญญาณความทุกข์',
