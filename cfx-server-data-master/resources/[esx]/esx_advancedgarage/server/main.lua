...
ESX.RegisterServerCallback('esx_advancedgarage:getOwnedAircrafts', function(source, cb)
	...
	if Config.DontShowPoundCarsInGarage == true then
		-- MySQL.Async.fetchAll('SELECT * FROM owned_vehicles WHERE owner = @owner AND Type = @Type AND job = @job AND stored = @stored AND owned_vehicles.plate NOT IN (SELECT plate from caruby_impound)', {
		...
		-- MySQL.Async.fetchAll('SELECT * FROM owned_vehicles WHERE owner = @owner AND Type = @Type AND job = @job AND owned_vehicles.plate NOT IN (SELECT plate from caruby_impound)', {
...
ESX.RegisterServerCallback('esx_advancedgarage:storeVehicle', function (source, cb, vehicleProps)
	...
	-- MySQL.Async.fetchAll('SELECT * FROM owned_vehicles WHERE owner = @owner AND @plate = plate AND owned_vehicles.plate NOT IN (SELECT plate from caruby_impound)', {
...
ESX.RegisterServerCallback('esx_advancedgarage:getOutOwnedPolicingCars', function(source, cb)
	...
	-- MySQL.Async.fetchAll('SELECT * FROM owned_vehicles WHERE owner = @owner AND job = @job AND stored = @stored AND owned_vehicles.plate NOT IN (SELECT plate from caruby_impound)', {
...
AddEventHandler('esx_advancedgarage:payAircraft', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {
		    text =  _U('you_paid') .. Config.AircraftPoundPrice,
		    type = "success",
		    timeout = 2000,
		    layout = "centerLeft"
		})
...
AddEventHandler('esx_advancedgarage:payBoat', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {
		    text =  _U('you_paid') .. Config.BoatPoundPrice,
		    type = "success",
		    timeout = 2000,
		    layout = "centerLeft"
		})
...
AddEventHandler('esx_advancedgarage:payCar', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {
		    text =  _U('you_paid') .. Config.CarPoundPrice,
		    type = "success",
		    timeout = 2000,
		    layout = "centerLeft"
		})
...
AddEventHandler('esx_advancedgarage:payPolicing', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {
		    text =  _U('you_paid') .. Config.PolicingPoundPrice,
		    type = "success",
		    timeout = 2000,
		    layout = "centerLeft"
		})
...
AddEventHandler('esx_advancedgarage:payAmbulance', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {
		    text =  _U('you_paid') .. Config.AmbulancePoundPrice,
		    type = "success",
		    timeout = 2000,
		    layout = "centerLeft"
		})
