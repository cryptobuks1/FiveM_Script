...
Config.DamageMult = 7 -- Higher Number = Higher Repair Price.

Config.CarPoundPrice      = 1000 -- Car Pound Price.
Config.BoatPoundPrice     = 3000 -- Boat Pound Price.
Config.AircraftPoundPrice = 5000 -- Aircraft Pound Price.
...
Config.DeleteMarker = {
	...
	x = 1.0, y = 2.0, z = 1.0  -- Big Size Circle
}
...
Config.PolicePounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 374.42, y = -1620.68, z = 29.29 },
		SpawnPoint = { x = 391.74, y = -1619.0, z = 28.29, h = 318.34 }
	},
	
	Pound_Sandy = {
		PoundPoint = { x = 1646.01, y = 3812.06, z = 38.65 },
		SpawnPoint = { x = 1627.84, y = 3788.45, z = 33.77, h = 308.53 }
	},
	
	Pound_Paleto = {
		PoundPoint = { x = -223.6, y = 6243.37, z = 31.49 },
...
Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 422.02401733398, y=-1029.3526611328, z=29.081623077393 },
		SpawnPoint = { x = 428.99427001953, y=-1020.5189731445, z=28.94386100769, h = 90.22 }
	},
	Pound_drugs = {
		PoundPoint = { x = 1849.4227294922, y=3689.1508789063, z=34.267063140869 },
		SpawnPoint = { x = 1858.5618896484, y=3673.6787109375, z=33.649436950684, h = 206.61 }
	},
	Pound_Paleto = {
