...
Config.DisableKeys = {0, 22, 23, 24, 29, 30, 31, 37, 44, 56, 71, 72, 82, 140, 166, 167, 168, 170, 288, 289, 311, 323}
...
Config.Strings = {
	ExitVehicle = "กรุณาดับเครื่องก่อนเติมน้ำมัน",
	EToRefuel = "กด ~g~E ~w~เพื่อเติมน้ำมัน",
	EToRefuel3 = "กด ~g~E ~w~เพื่อเรียกเด็กปั๊ม",
	JerryCanEmpty = "น้ำมันหมด",
	FullTank = "เต็มถังแล้ว",
	PurchaseJerryCan = "กด ~g~E ~w~เพื่อซื้อแกลอนน้ำมัน ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "กด ~g~E ~w~เพื่อหยุดเติมน้ำมัน",
	CancelFuelingJerryCan = "กด ~g~E ~w~เพื่อหยุดเติมน้ำมัน",
	NotEnoughCash = "คุณไม่มีเงินเหลือแล้ว",
	RefillJerryCan = "กด ~g~E ~w~ เพื่อเติมน้ำมันใส่แกลอน ",
	NotEnoughCashJerryCan = "คุณมีเงินเหลือพอที่จะซื้อน้ำมัน",
	JerryCanFull = "น้ำมันเต็มแกลอนแล้ว"
}
