...
function syncSettings()
	...
	NetworkSetTalkerProximity(25.0)     					  -- Voice Proximity
...
Citizen.CreateThread( function()
	while true do
		...
		if ( IsControlJustReleased( 0, 10 ) or IsDisabledControlJustReleased( 0, 10 ) ) and GetLastInputMethod( 0 ) and not IsPauseMenuActive() and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f1
		...
		if ( IsControlJustReleased( 0, 11 ) or IsDisabledControlJustReleased( 0, 11 ) ) and GetLastInputMethod( 0 ) and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f3
			teleportToWaypoint()
		end

		if ( IsControlJustReleased( 0, 121 ) or IsDisabledControlJustReleased( 0, 121 ) ) and GetLastInputMethod( 0 ) and ((settings["adminOnlyNoclip"] == true and adminStatus == true) or settings["adminOnlyNoclip"] == false) then
			toggleNoClipMode()
		end
