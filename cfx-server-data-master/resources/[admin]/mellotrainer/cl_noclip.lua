...
function createNoClipMenuOptions()
    local options = {"เปิดปิดโหมดบิน: F5","W = ไปข้างหน้า","S = ไปข้างหลัง","A = เลี่ยวซ้าย","D = เลี่ยวขวา","Q = บินขึ้นสูง","E = ลงข้างล่า","Shift = เพื่อเปรี่ยนความเร็ว"}
    local speeds = { "ช้าที่สุด", "ช้าลง", "ช้า", "ปกติ", "รวดเร็ว", "เร็วขึ้น", "เร็วที่สุด" }
    local menuOpts = {}
    ...
    local curSpeed = {["menuName"] = "ความเร็วตอนนี้ = "..(speeds[travelSpeed] or "NA")}
